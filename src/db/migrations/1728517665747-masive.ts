...
export class Massiive1728517665747 implements MigrationInterface {
  name = 'Massiive1728517665747';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "customer_review" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" text, "text" text, "rating" double precision, "review_submission_time" text, "user_nickname" text, "nanoid" text NOT NULL, CONSTRAINT "UQ_a7a34d55cffa0cfef59f3cba01a" UNIQUE ("nanoid"), CONSTRAINT "PK_ee7bdbc5f6f31cb09073832da26" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."products_offer_type_enum" AS ENUM('ONLINE_AND_STORE', 'ONLINE_ONLY')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "product_customer_review" ("product_item_id" uuid NOT NULL, "customer_review_id" uuid NOT NULL, CONSTRAINT "PK_db95a077b324335e80e422bfbf0" PRIMARY KEY ("product_item_id", "customer_review_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_034ecaee9fd8a6fc08e0e65f22" ON "product_customer_review" ("product_item_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_276d8015682927a4f9311a7ec0" ON "product_customer_review" ("customer_review_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_customer_review" ADD CONSTRAINT "FK_034ecaee9fd8a6fc08e0e65f22c" FOREIGN KEY ("product_item_id") REFERENCES "products"("uuid") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_customer_review" ADD CONSTRAINT "FK_276d8015682927a4f9311a7ec07" FOREIGN KEY ("customer_review_id") REFERENCES "customer_review"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "product_customer_review" DROP CONSTRAINT "FK_276d8015682927a4f9311a7ec07"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_customer_review" DROP CONSTRAINT "FK_034ecaee9fd8a6fc08e0e65f22c"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_276d8015682927a4f9311a7ec0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_034ecaee9fd8a6fc08e0e65f22"`,
    );
    ...
    await queryRunner.query(`DROP TYPE "public"."products_offer_type_enum"`);
