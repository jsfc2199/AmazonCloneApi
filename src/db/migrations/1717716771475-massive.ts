...
export class Massive1717716771475 implements MigrationInterface {
  name = 'Massive1717716771475';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "customer_review" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" text, "text" text, "rating" double precision, "review_submission_time" text, "user_nickname" text, CONSTRAINT "PK_ee7bdbc5f6f31cb09073832da26" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
